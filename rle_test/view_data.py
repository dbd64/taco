...
path_out = '/Users/danieldonenfeld/Developer/taco/rle_test/plots_vec_compute/'
...
for b in data['benchmarks']:
    ...
    d_key = "values: [" + str(vals_l) + "," + str(vals_u) + "]" + \
        ", run lengths: [" + str(rle_l) + "," + str(rle_u) + "]"

    if 'dense' in case:
        dense_data_x, dense_data_y, _, _ = d.setdefault(
            d_key, ([], [], [], []))
